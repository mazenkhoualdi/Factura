...
export const KPIs = () => {
  const { clients, societies, devis, factures, paiements } = useAppContext();
  ...
  const totalContacts = clients.length + (societies?.length || 0);

  const kpis = [
    { label: "Total Clients & Sociétés", value: totalContacts, color: "#1976d2" },
